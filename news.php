            ...
            <div class="col-sm-12 col-lg-8">
                <div href="news" class="top-news" style="height: 600px;">
                    ...
                    <div class="text">
                        ...
                        <a class="white" href="news-details.php">
                ...
                <div class="row">
                    <div class="col-sm-12 col-lg-6">
                        <div class="news-block mb-3 shadow bg-white rounded">
                            ...
                            <div class="news-block-content">
                                ...
                                <a class="red hover-black" href="news-details.php"><h2>Couple of cool mock-up ideas</h2></a>
                                <p class="short-text">
                                ...
                                <div class="footer-news-block d-flex align-items-center justify-content-between">
                                    <a href="news-details.php" class="category-link red hover-black">Design</a>
                                    <a href="news-details.php" class="comment-link red hover-black"><i class="fas fa-comment-alt"></i> 14</a>
                                </div>
                        ...
                        <div class="news-block mb-3 shadow bg-white rounded">
                            ...
                            <div class="news-block-content">
                                ...
                                <a class="red hover-black" href="news-details.php"><h2>An iPhone a day keeps the doctor away</h2></a>
                                <p class="short-text">
                                ...
                                <hr>
                                <div class="footer-news-block d-flex align-items-center justify-content-between">
                                    <a href="news-details.php" class="category-link red hover-black">Medicine</a>
                                    <a href="news-details.php" class="comment-link red hover-black"><i class="fas fa-comment-alt"></i> 48</a>
                                </div>
                    ...
                    <div class="news-block mb-3 shadow bg-white rounded">
                        ...
                        <div class="news-block-content">
                            ...
                            <a class="red hover-black" href="news-details.php"><h2>Fast forward: What's coming in future versions of Chrome?</h2></a>
                            <p class="short-text">
                                Ut et lacus ex. Aliquam dignissim mauris 
                                sit amet purus convallis, vitae vehicula lectus tincidunt. Nulla placerat…
                            </p>
                            <hr>
                            <div class="footer-news-block d-flex align-items-center justify-content-between">
                                <a href="news-details.php" class="category-link red hover-black">Technology</a>
                                <a href="news-details.php" class="comment-link red hover-black"><i class="fas fa-comment-alt"></i> 36</a>
                            </div>
                    ...
                    <div class="news-block mb-3 shadow bg-white rounded">
                        ...
                        <div class="news-block-content">
                            ...
                            <a class="red hover-black" href="news-details.php"><h2>How Microsoft will end Office's perpetual licensing</h2></a>
                            <p class="short-text">
