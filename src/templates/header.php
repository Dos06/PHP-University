...
<div class="mobile-menu">
    <div class="mm-inner" id="menuBar">
        <ul class="">
            <li class="nav-item my-auto"><a href="index.php" class="menu nav-link">Home</a></li>
            <li class="nav-item my-auto"><a href="news.php" class="menu nav-link">News</a></li>
            <li class="nav-item my-auto"><a href="admission.php" class="menu nav-link">Admission</a></li>
            <li class="nav-item my-auto"><a href="innovation.php" class="menu nav-link">Innovation</a></li>
            <li class="nav-item my-auto"><a href="innovation.php" class="menu nav-link">Profile</a></li>
            <li class="nav-item my-auto"><a href="php_backend/login/signout.php" class="btn btn-secondary menu nav-link">Signout</a></li>
                ...
                <div class="row w-100">
                    <div class="col-sm-1">
                        <a class="navbar-brand" href="/">
                            <img src="src/static/img/iitu_logo_header.png" width="200" height="auto" alt="" loading="lazy">
                        </a>
                    </div>
                    <!--             
                    ...
                    <div class="col-sm-8 offset-3 d-flex">
                        <div class="collapse navbar-collapse">
                            <ul class="navbar-nav ml-auto">
                                <li class="link nav-item my-auto active"><a href="index.php" class="nav-link">Home</a></li>
                                <li class="link nav-item my-auto"><a href="news.php" class="nav-link">News</a></li>
                                <li class="link nav-item my-auto"><a href="admission.php" class="nav-link">Admission</a></li>
                                <li class="link nav-item my-auto"><a href="innovation.php" class="nav-link">Innovation</a></li>
                                <li class="link nav-item my-auto"><a href="profile.php" class="nav-link">Profile</a></li>
                                <li class="link nav-item my-auto"><a href="php_backend/login/signout.php" class="btn-reg btn btn-danger">Sign out</a></li>
...
<div class="mobile-menu">
    <div class="mm-inner" id="menuBar">
        <ul class="">
            ...
            <li class="nav-item my-auto"><a href="admission.php" class="menu nav-link">Admission</a></li>
            <li class="nav-item my-auto"><a href="innovation.php" class="menu nav-link">Innovation</a></li>
            <li class="nav-item my-auto mr-3"><a href="login.php" class="btn-reg btn btn-danger" style="float:right;">Sign In</a></li>
            <li class="x-menu my-auto white" id="x-menu"><i class="fas fa-times fa-2x"></i></li>
        </ul>
    </div>
</div>
                    ...
                    <div class="col-sm-8 offset-3 d-flex">
                        <div class="collapse navbar-collapse">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="link nav-item my-auto"><a href="admission.php" class="nav-link">Admission</a></li>
                                <li class="link nav-item my-auto"><a href="innovation.php" class="nav-link">Innovation</a></li>
                                <li class="link nav-item my-auto"><a href="login.php" class="btn-reg btn btn-danger">Sign In</a></li>
                                <li class="hamburger-menu my-auto" id="hr-menu"><i class="fas fa-bars fa-1x"></i></li>
                            </ul>
                        </div>
                    </div>
